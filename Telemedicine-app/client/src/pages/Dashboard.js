...
const DashboardHeader = styled(Box)(({ theme }) => ({
  ...
  backgroundImage: 'url("/images/patient-dashboard-header.jpg")', // Add this image to your project
    ...
    <>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={8}>
          ...
          <Box sx={{ 
            backgroundImage: 'url("/images/appointment-bg.jpg")', // Add this decorative image
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            p: 2,
            borderRadius: 4,
    ...
    <>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={8}>
          ...
          <Box sx={{ 
            backgroundImage: 'url("/images/doctor-appointment-bg.jpg")', // Add this decorative image
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            p: 2,
            borderRadius: 4,
